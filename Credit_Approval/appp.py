...
if st.session_state.scan_done:
    ...
    # ── 2. FULL PAGE DATAFRAME ──
    # height=600 અને use_container_width=True થી બધી જ કોલમ્સ પ્રોપરલી સેટ થઈ જશે
    # આમાં તમારી બધી જ ફિલ્ડ્સ (Gender_Male, Married_Yes વગેરે) ડિસ્પ્લે થશે
    st.dataframe(
